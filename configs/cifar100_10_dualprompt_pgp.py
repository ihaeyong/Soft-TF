...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--target_layers', default=[11], type=int, nargs = "+", help='the layer indexs')
    ...
    subparsers.add_argument('--e_prompt_layer_idx', default=[9,10,11], type=int, nargs = "+", help='the layer index of the E-Prompt')
    ...
    # Sparse
    subparsers.add_argument('--subnet', default='dense', type=str,)
    subparsers.add_argument('--sparsity', default=0.0, type=float,)
    subparsers.add_argument('--sparse_patch_c', default=0.0, type=float,)
    subparsers.add_argument('--num_register_tokens', default=0, type=int,)
    subparsers.add_argument('--infer_type', default='prompt', type=str,)
    subparsers.add_argument('--param_ratio', default=4, type=int,)

    # Gradient perturbation
    subparsers.add_argument('--g_perturb_type', default='None', type=str, help='if using the gradient perturbation')
    subparsers.add_argument('--config', default='None', type=str,)

    subparsers.add_argument('--noise_scale', default=0.01, type=float,)
    subparsers.add_argument('--rho_max', default=1.0, type=float,)
    subparsers.add_argument('--rho_min', default=1e-3, type=float,)
    subparsers.add_argument('--sparsity_grad', default=0.0, type=float,)

    # Use LoRA Attention
    subparsers.add_argument('--use_lora', action="store_true", help='if using the lora')