...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--target_layers', default=[5], type=int, nargs = "+", help='the layer indexs')
    ...
    subparsers.add_argument('--e_prompt_layer_idx', default=[5], type=int, nargs = "+", help='the layer index of the E-Prompt')
