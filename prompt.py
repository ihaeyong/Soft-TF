...
class EPrompt(nn.Module):
    ...
    def forward(self, x_embed, prompt_mask=None, cls_features=None, infer_id=-1, gt_id=-1, mode='train'):
        out = dict()
        ...
        if self.prompt_pool:
            ...
            if self.batchwise_prompt:
                ...
                if infer_id >= 0:
                    major_prompt_id = torch.ones_like(prompt_id[major_idx]) * infer_id
                else:
            ...
            if prompt_mask is not None:
                ...
                if gt_id != idx[0].item() and gt_id > 0:
                    print('Prompt, Task_id:', gt_id, 'Infer_id:', idx[0].item())
